...
I formati database v2/v3 e i release plan v1-v6, inclusi il consuntivo attestato e il confronto fra snapshot, sono documentati in [docs/JSON-DATABASE.md](docs/JSON-DATABASE.md). Un piano importabile è disponibile in [data/study-program-example.json](data/study-program-example.json).
